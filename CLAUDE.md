...
python -m src.calculate_emissions      # runs __main__ block — update year/month inside
```
...
`src/batch.py` is a legacy file that is no longer functional and will be removed.
